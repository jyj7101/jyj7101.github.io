...
[버텍스 단위] [좌표 변환](/posts/5-Depth(a-k-a-Z-Buffer)-410e22eca2134669bbc3c94076a4b513), [후면 컬링(BackFace Culling)](/posts/3-Backface-Culling-&-Rodrigues-rotation-10862cd2309349e29a8fb8c5cde1385c) 및 [삼각형 클리핑](/posts/8-Triangle-Clipping-c2331e1b7c97414a96a0cb9b3e007609) →

[래스터화](/posts/10-Screen,-Rasterization,-Line-99bc5b23073e4eb2bbcce66ce6d2c15e/) →

[픽셀 단위] [깊이 버퍼 테스트(Z-Test)](/posts/5-Depth(a-k-a-Z-Buffer)-410e22eca2134669bbc3c94076a4b513/) → 스텐실 테스트 → 알파블렌딩 → 
...
절두체 처리할 때 했던 [그거](/posts/6-Frustum-7b6583bdabeb4c50938a76f97ae32639/) 아시죠?
