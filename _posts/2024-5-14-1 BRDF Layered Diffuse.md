...
램버트 계면이 빛 전송 적분을 비상관화(decorrelation)하는 사실을 이용하여 이러한 통계를 원자적 사전 계산으로 축소하고, 분석적 표현식과 결합합니다. 
...
여기서 $$x = x_i [0,n] \in \Omega_n$$은 길이 $$n$$의 모든 경로입니다. 램버트 상호작용으로 인해, 각 버텍스에서의 적분은 비상관화(decorrelation)됩니다:
